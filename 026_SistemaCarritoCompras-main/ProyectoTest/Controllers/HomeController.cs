...
namespace ProyectoTest.Controllers
{
    ...
    {
        public ActionResult Index(bool? Administrador)
        {
            Usuario oUsuario = new Usuario();
            if (Session["Usuario"] != null && Administrador == true )
            {
                ViewBag.MostrarPestañas = true;
                TempData["Administrador"] = Administrador;
                return View();
            }
            else
            {
                ViewBag.MostrarPestañas = false;
                TempData["Administrador"] = Administrador;
                return View();
            }
        }

        private bool ObtenerAdministrador()
        {
            Usuario oUsuario = new Usuario();
        ...
        {
            bool Administrador = ObtenerAdministrador();
            Administrador = TempData["Administrador"] as bool? ?? Administrador;
            Usuario oUsuario = new Usuario();
            if (Session["Usuario"] != null && Administrador == true)
            {
                ViewBag.MostrarPestañas = true;
        ...
        public JsonResult ListarProducto()
        {
            ...
            JsonResult jsonResult = Json(new { data = oLista }, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult GuardarProducto(string objeto, HttpPostedFileBase imagenArchivo)
        {
            ...
            JsonResult jsonResult = Json(oresponse, JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
